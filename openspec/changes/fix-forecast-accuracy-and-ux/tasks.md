...
- [x] 1.4 Verificar contra los specs: `spot-catalog` — los 4 requisitos y sus 7 escenarios
...
- [x] 2.6 Verificar contra los specs: `marine-data` — los 4 requisitos y sus 6 escenarios
...
- [x] 3.5 Verificar contra los specs: `tide-extremes` — los 3 requisitos y sus 6 escenarios
...
- [x] 4.4 Verificar contra los specs: `forecast-timeline` — los 4 requisitos y sus 7 escenarios
...
- [x] 5.6 Verificar contra los specs: `condition-rating` — los 4 requisitos y sus 9 escenarios
...
- [x] 6.5 Ejecutar la suite completa en verde
- [x] 6.6 `npm run build` en verde con Node ≥ 20.9
- [x] 6.7 Actualizar `CLAUDE.md`: endpoints correctos, unidades, comando de test real

## 7. Despliegue

- [x] 7.1 Fijar la raíz de Turbopack en `next.config.ts`: la inferida subía por encima del repo y dejaba el cliente sin hidratar
- [x] 7.2 Corregir el mismatch de hidratación (React #418) del UI dependiente de la hora
